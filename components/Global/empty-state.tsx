...
export const EmptyStateComponent: React.FC<EmptyStateComponentProps> = ({title, description, imageUrl}) => {
    return (
        <div className="flex flex-col items-center justify-center mt-10 mx-4">
            <Image src={"/empty-steps.svg"} alt="empty state" className="object-contain" width={350} height={350} />
