...
export function SubFeature() {
  const features = [
    {
      title: "Track Your Learnings and Maintain Streaks",
      description:
        "Track Your Learning and maintain your streaks on codesnippet not on snapchat😂",
  ...
  return (
    <div className="z-20 py-10 lg:py-40 max-w-full dark:bg-black bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative">
...
export const SkeletonThree = () => {
  return (
    <Link
      ...
      aria-label="Watch our AI on YouTube"
    >
