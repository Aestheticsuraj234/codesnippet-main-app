...
export default function LiveCourseLandingPage({ course }: Props) {
        ...
        <section className="mb-20 grid gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-6 text-lg text-muted-foreground">
              {currentCourseData?.CourseOverViewDes}
            </p>
            ...
            <Card className="mb-6">
              <CardContent className="p-4">
                ...
                <ul className="space-y-2">
                  {currentCourseData?.courseHighlights.map(
                    (highlight, index) => (
        ...
        <section className="mb-20">
          ...
          <div className="flex flex-col items-center md:flex-row md:items-start md:space-x-8">
            ...
            <div>
              ...
              <p className="mb-4">
                Suraj has been working as a full-stack software engineer as a
                freelancer for the past three years and has completed more than
                three internships at Indias biggest tech companies while in
                college. He has helped over 4,000 students start their web
                development journey, and he is still in his 3rd year of college.
              </p>
