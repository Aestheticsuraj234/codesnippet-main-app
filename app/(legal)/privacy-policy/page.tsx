...
export const metadata = {
  ...
  description:
    "Learn about how CodeSnippet collects, uses, and protects your personal information.",
};
    ...
    <div className="container max-w-4xl mx-auto px-4 py-12 md:py-16">
      <div className="space-y-8">
        ...
        <section id="introduction" className="space-y-4">
          ...
          <p>
            Welcome to CodeSnippet. We are committed to protecting your privacy
          ...
          <div className="pl-4 space-y-4">
            <div>
              ...
              <p>
                ...
                contact us, we may collect personal information such as your
            ...
            <div>
              ...
              <p>
                We collect information on how you access and use the CodeSnippet
            ...
            <div>
              ...
              <p>
                ...
                on our website and hold certain information. You can control the
                use of cookies at the individual browser level.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="pl-4 space-y-4">
            <div>
              ...
              <p>
                ...
                account, provide customer support, and process transactions.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Usage data helps us understand how our services are being used
            ...
            <div>
              ...
              <p>
                We may use your information to send newsletters, promotional
                ...
                the unsubscribe link in the emails or by contacting us at{" "}
                <Link
            ...
            <div>
              ...
              <p>
                We use your information to enforce our terms and conditions,
                including detecting and preventing fraud or other unauthorized
                activities.
              </p>
            </div>
          </div>
        ...
        <section id="data-retention" className="space-y-4">
          ...
          <p>
            ...
            to fulfill the purposes for which it was collected or to comply with
            legal obligations.
          </p>
        </section>
          ...
          <div className="pl-4 space-y-4">
            ...
            <div>
              ...
              <p>
                ...
                unsubscribe link in the emails or by contacting us at{" "}
                <Link
                  href="mailto:codesnippet003@gmail.com"
                  className="text-primary hover:underline"
                  aria-label="Contact us via email"
        ...
        <section id="childrens-privacy" className="space-y-4">
          ...
          <p>
            ...
            remove such information and terminate the child account.
          </p>
        </section>
        ...
        <div className="mt-12 pt-8 border-t">
          <p className="text-center text-muted-foreground">
            By using CodeSnippet services, you acknowledge that you have read and
