...
const ChapterIdPage = async(
  ...
  const CourseChapterData = await getChapterWiseDataWithCourseId(params.id,params.chapterId)
...
const isMarkasDone = CourseChapterData?.chapterProgression.length > 0 ? CourseChapterData?.chapterProgression[0].markedAsDone : false
